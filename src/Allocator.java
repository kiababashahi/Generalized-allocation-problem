...
public class Allocator {
	...
	public static void main(String[] args) {
		...
		Local_Search l1=new Local_Search(rd.a, h.objective_value, r1, h.x, rd.c, h.b, h.allocated_costs,h.optimum);		
		l1.search();
		Random rn1=new Random();//1245
		//System.out.println(h.optimum);
		//Random ran=new Random();
		int k=0;
		Meta m=new Meta(l1.assignments, l1.a, l1.c, l1.b, l1.costs_Assigned, l1.objective, l1.optimal);
		while(m.objective-m.optimal>10 && k<1000) {
			//System.err.println("hereeee");
		int cn=rn1.nextInt(l1.costs_Assigned.size());
		m.set_candidate(cn);
		m.new_assignment();
		k++;
	}
